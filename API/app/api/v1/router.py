...
from app.controllers.supplier_controller import router as suppliers_router
...
api_router.include_router(suppliers_router, prefix="/fornecedores", tags=["fornecedores"])
