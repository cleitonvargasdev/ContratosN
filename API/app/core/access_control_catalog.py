...
RESOURCE_CATALOG: tuple[PermissionResourceRead, ...] = (
    ...
    PermissionResourceRead(resource_key="marcas", resource_label="Marcas", resource_group="Cadastros", supported_actions=["create", "read", "update", "delete"]),
    PermissionResourceRead(resource_key="produtos", resource_label="Produtos", resource_group="Cadastros", supported_actions=["create", "read", "update", "delete"]),
    PermissionResourceRead(resource_key="fornecedores", resource_label="Fornecedores", resource_group="Cadastros", supported_actions=["create", "read", "update", "delete"]),
    PermissionResourceRead(resource_key="contas_pagar", resource_label="Contas a Pagar", resource_group="Cadastros", supported_actions=["create", "read", "update", "delete"]),
