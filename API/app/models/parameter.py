...
class Parametro(Base):
    ...
    token_api_whatsapp: Mapped[str | None] = mapped_column(String(30), nullable=True)
    regra_nono_dig_whats: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
