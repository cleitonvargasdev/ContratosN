...
class User(Base):
    ...
    recebe_comissao_venda: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    taxa_venda: Mapped[float | None] = mapped_column(nullable=True)
    recebe_comissao_cob: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    taxa_cob: Mapped[float | None] = mapped_column(nullable=True)
