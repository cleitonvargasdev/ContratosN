    ...
    async def _ensure_whatsapp_api_configs(self, parameter: Parametro) -> bool:
        ...
        defaults = [
            ...
            },
            {
                ...
                "url": f"{settings.quepasa_apiwpp_url.rstrip('/')}/send",
                "key1": "Accept",
                "value1": "application/json",
                "key2": "Content-Type",
                "value2": "application/json",
                "key3": "X-QUEPASA-TOKEN",
                "value3": "{token_api_whatsapp}",
                "key4": "X-QUEPASA-CHATID",
                "value4": "{chatid}",
                "key5": "X-QUEPASA-TRACKID",
                "value5": "Financeiro",
            ...
            },
            {
                ...
                "url": f"{settings.quepasa_apiwpp_url.rstrip('/')}/send/document",
                "key1": "Content-Type",
                "value1": "application/json",
                "key2": "X-QUEPASA-TOKEN",
                "value2": "{token_api_whatsapp}",
                "body": '{"chatId":"{chatId}","url":"{url}","fileName":"documento.pdf","caption":"{text}"}',
            },
            {
                "nome_api": "quepasa",
