...
const baseSections: SidebarSection[] = [
  {
    ...
    links: [
      ...
      { label: 'Fornecedores', to: '/fornecedores', resource: 'fornecedores', action: 'read', icon: 'contacts' },
      ...
      { label: 'Contas à Pagar', to: '/contas-pagar', resource: 'contas_pagar', action: 'read', icon: 'wallet' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Pagamentos', to: '/movimentacoes/pagamentos', resource: 'contas_pagar', action: 'read', icon: 'payment' },
      { label: 'Comissões', to: '/comissoes', resource: 'contas_pagar', action: 'read', icon: 'wallet' },
    ],
  },
  {
    title: 'Relatórios',
